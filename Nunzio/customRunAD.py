...
def main(configuration:dict, name:str)->None:
    ...
    save_path = f"results_{max(0, max(int(fname.split('_')[1].split('.')[0]) for fname in os.listdir(out_initial_path) if fname.startswith("results_") and fname.endswith(".json"))) + 1}.json"
